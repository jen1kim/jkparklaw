...
<asp:ScriptManager ID="ScriptManager2" runat="server">
    ...
    <table class="editTable">
        <tr>
            <td colspan="3" class="head"><strong>Board List </strong></td>
        </tr>
        <tr>
            <td colspan="3">
                &nbsp;
        ...
        <tr>
            <td colspan="3">
                <b>Category:</b>&nbsp;
                <asp:DropDownList ID="ddlBoardCatID_Sort" runat="server" DataSourceID="DS_BoardCategory" DataTextField="BoardCategory" DataValueField="BoardCatID" CssClass="multiselect" AutoPostBack="true" OnSelectedIndexChanged="RefreshList"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td colspan="3"> 
                <asp:GridView ID="gridList" runat="server" AutoGenerateColumns="False"  AllowPaging="true" PageSize="15"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="OrderNoDisplay" HeaderText="Display Order" InsertVisible="False" ItemStyle-Width="50px"  ItemStyle-HorizontalAlign="Center"
                            ReadOnly="True"  />
                        <asp:BoundField DataField="BoardCategory" HeaderText="Category" ItemStyle-Width="120px" />
                        <asp:BoundField DataField="BoardTitle" HeaderText="Title" ItemStyle-Width="250px" />
    ...
    <table class="editTable">
        <tr>
            ...
            <td>
                <asp:Button ID="btAdd" runat="server" Text="Add Message"  ValidationGroup="AddNew" OnClick="btAdd_Click" CssClass="commandButton" />
            </td>
        </tr>
    </table>
        </ContentTemplate>
