...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminPlaceHolder" runat="server">
    ...
    <table class="editTable" width="100%">
        <tr>
            <td colspan="3" class="head"><strong>SECTIONS</strong></td>
        </tr>            
        <tr>
            <td colspan="3">
                <asp:GridView ID="SectionsList" runat="server" AutoGenerateColumns="False" 
                    ...
                    AllowSorting="True" SkinID="Gridview" OnPageIndexChanging="SectionsList_PageIndexChanging">
                    <Columns>
    ...
    <table class="editTable">
        ...
        <tr>
            <td style="width:100px"> Section Name*</td>
            <td colspan="2">
                <asp:TextBox  ID="SectionName" runat="server" MaxLength="125" Width="300px" CssClass="editInput">  </asp:TextBox>
        ...
        <tr>
            <td> Section Desc*</td>
            <td colspan="2">
                <asp:TextBox  ID="SectionDesc" runat="server" MaxLength="125" Width="300px" CssClass="editInput">  </asp:TextBox>
        ...
        <tr>
            <td >
                &nbsp;</td>
            <td colspan="2">
                <asp:Button ID="btnAddNewSection" runat="server" Text="Add new section" ValidationGroup="AddNew" CssClass="commandButton"
