...
<asp:ScriptManager ID="ScriptManager2" runat="server">
    ...
    <table class="editTable">
        ...
        <tr>
            ...
            <dxwgv:ASPxGridView ID="ProgressGV" runat="server" ClientInstanceName="ProgressGV" OnRowUpdating="ProgressGV_RowUpdating"
                    AutoGenerateColumns="False" Width="100%" KeyFieldName="ProgressID" DataSourceID="dsProgressView" >
    ...
    <table class="editTable">  
        ...
        <tr>
            <td style="width:100px;height:25px;">Title <span style="color:Red;">*</span></td>
            <td colspan="2">
                <asp:TextBox  ID="tbNewTitle" runat="server" MaxLength="125" Width="500px" CssClass="editInput"></asp:TextBox>                
            </td>
    ...
    <table class="editTable">
        ...
        <tr>
            <td  style="width:100px;height:25px;"> 
                ...
                Title*</td>
            <td>
                <asp:TextBox  ID="tbEditTitle" runat="server" MaxLength="125" Width="500px" CssClass="editInput">  </asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width:100px">Small desc</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="UpdateDetails" runat="server" Text="Update Progress"  ValidationGroup="Update" OnClick="UpdateDetails_Click" CssClass="commandButton" />
            </td>
        </tr>
    </table>
    </div>
