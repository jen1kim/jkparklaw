...
namespace JKParkLaw.Controls.Categories
{
    public partial class ContentsListing : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _PcategoryID = ((JKParkLaw.Categories.Category)this.Page).PCategoryID;
        ...
        {
            return "/Categories/Category.aspx?CategoryID=" + _categoryID.ToString() + "&ContentID=" + newsID.ToString();
        }
