<%@ Control Language="C#"  EnableTheming="false" EnableViewState="false" AutoEventWireup="false" Inherits="FredCK.FCKeditorV2.FileBrowser.Config" %>
<%--
...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        UserFilesPath = DBBase.Configuration.GetKey("SiteUrl") + "/Files/site/";
        ...
        UserFilesAbsolutePath = DBBase.Configuration.GetKey("SiteDir") + "/Files/site/";
