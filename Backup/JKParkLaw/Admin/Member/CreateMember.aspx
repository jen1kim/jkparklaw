...
<asp:ScriptManager ID="ScriptManager2" runat="server">
                    ...
                    <table width="100%" id="registerTable" runat="server" class="editTable" >
                        <tr>
                            ...
                            <td><asp:TextBox ID="tbMemberID" runat="server" MaxLength="125" Width="200px" AutoPostBack="true" OnTextChanged="tbMemberID_TextChanged"></asp:TextBox></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:Button ID="btnResister" runat="server" Text="Create Member" 
                                    onclick="btnResister_Click" ValidationGroup="AddNew" CssClass="commandButton" /></td>
                        </tr>
                    </table>
                    </ContentTemplate> 
                    </asp:UpdatePanel>
