    ...
    public partial class Success : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            ...
            foreach (DataRow dr in content.Rows)
            {
                ...
                lblNewsTitle.Text = dr.ItemArray[2].ToString();
                lblNewsDate.Text = String.Format("{0:M/d/yyyy}", DateTime.Parse(dr.ItemArray[1].ToString()));
                NewsContentDiv.InnerHtml = dr.ItemArray[3].ToString();
            }
