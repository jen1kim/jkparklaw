            ...
            <td align="center" style="padding: 30px 0; border: 1px solid #ddd1c8;">
                    <table align="center" cellspacing="0" cellpadding="0" width="340" border="0">
                      <tr valign="middle">
                            ...
                            <td width="245" align="right"><asp:textbox id="txtMid" tabIndex="1" runat="server" MaxLength="20" Width="240px"  cssclass="form-control"></asp:textbox></td>
                      </tr>
                      <tr valign="middle">
                      ...
                      <tr valign="middle">
                            ...
                            <td width="245" align="right"><asp:textbox id="txtMpwd" tabIndex="1" runat="server" MaxLength="20" Width="240px"  cssclass="form-control" TextMode="Password"></asp:textbox></td>
                      </tr>
                      <tr>
                            <td>&nbsp;</td>
                            <td align="center" valign="bottom" style="padding: 10px 0 0 0;">
                                <asp:button id="btLogin" Text="Enter" tabIndex="2" Runat="server" Width="64px" Height="25px" CssClass="btn btn-primary" OnClick="btLogin_Click">
                            </asp:button></td>
                      </tr>
                    </table>
